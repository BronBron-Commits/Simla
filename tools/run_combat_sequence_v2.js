...
const file = "examples/combat_loop_stateful_v2.sim";
...
if (actions.length === 0) {
  console.log("Usage:");
  console.log("  node tools/run_combat_sequence_v2.js move:8 end:0 attack:10 end:0");
  process.exit(0);
}
